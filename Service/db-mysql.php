...
class MysqlDB {
    ...
    * @param array $params Contains all the params that we need to bind into query
    * @return array Contains the returned rows from the query.
    */
    public function fetchAll($query, $params = array())
    {
        $this->_query = $this->_sqlBind($query, $params);
    ...
    */
    ...
    {
        $this->_where[$whereProp] = $this->_mysql->real_escape_string($whereValue);
        return $this;
    }
    ...
    */
    ...
    /**
    * This helper method binds the parameters to the query string using str_replace.
    * The values passed to the query string are escaped using mysqli::real_escape_string() method
    *
    * @param object $stmt Equal to the prepared statement object.
    * @return array The results of the SQL fetch.
    */
    protected function _sqlBind($query, $params)
    {
        //$query = filter_var($query, FILTER_SANITIZE_STRING);
        foreach($params as $name=>$value)
        {
            $query = str_replace(':' . $name, "'" . $this->_mysql->real_escape_string($value) . "'", $query);
        }
        return $query;
    }
    ...
    */
    protected function _prepareQuery()
    {
        ...
        {
            trigger_error("Problem preparing query: " . $this->_query, E_USER_ERROR);
        }
        return $stmt;
    }
